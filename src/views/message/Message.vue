...
export default {
  ...
  setup(){
    ...
    let cover =  "background: url(" + "https://laravel-shop-api-y.oss-cn-hangzhou.aliyuncs.com/config/7edfa281ceb9b7beb3e700e546c4619b.jpg" + ") center center / cover no-repeat";
    onMounted(()=>{
      getMessageList()
    })
    return{
